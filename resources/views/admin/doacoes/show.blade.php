                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <dl class="row mb-0">
                                    ...
                                    <dd class="col-sm-8">{{ \Carbon\Carbon::parse($doacao->data_doacao)->format('d/m/Y') }}
                                    </dd>

                                    <dt class="col-sm-4">Tipo:</dt>
                                    <dd class="col-sm-8"><span
                                            class="badge bg-info text-dark">{{ ucfirst($doacao->tipo) }}</span></dd>
                                    ...
                                    @if($doacao->tipo === 'dinheiro')
                                        ...
                                        <dd class="col-sm-8 fw-bold text-success">R$
                                            {{ number_format($doacao->quantidade, 2, ',', '.') }}
                                        </dd>
                                    @endif
                                </dl>
                            </div>
                                ...
                                <table class="table table-striped table-hover mb-0">
                                    ...
                                    <tbody>
                                        @foreach($doacao->itens as $item)
                                            <tr>
                                                <td>{{ $item->nome }}</td>
                                                <td class="text-end">{{ $item->formatted_quantidade ?? $item->pivot->quantidade }}
                                                </td>
                            ...
                            @foreach($logs as $log)
                                <div class="list-group-item">
                                    <div class="d-flex w-100 justify-content-between">
                                        ...
                                        <small class="text-muted">{{ $log->created_at->diffForHumans() }}
