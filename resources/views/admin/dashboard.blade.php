        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('users.index') }}" class="btn btn-success mb-3">
                        Ver todos os usuários
                    </a>
                    <hr>
                    <h4>Gerenciamento de Paróquias</h4>
                    <a href="{{ route('paroquias.index') }}" class="btn btn-primary mb-3">
                        Ver todas as paróquias
                    </a>
                    <hr>
                    <h4>Gerenciamento de Doadores</h4>
                    <a href="{{ route('doadores.index') }}" class="btn btn-warning mb-3">
