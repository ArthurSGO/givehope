        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="{{ $isAdmin ? route('admin.dashboard') : route('painel.dashboard') }}"
                                                    ...
                                                    @foreach ($grupo['estoques'] as $estoque)
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a href="{{ route('estoque.show', $estoque->id) }}"
                                                                    class="btn btn-sm btn-outline-primary" title="Ver Extrato">
                                                                    <i class="fa-solid fa-list-ol"></i> Extrato
                                                                </a>
                                                            </td>
                                                        </tr>
                                                    @endforeach
                        ...
                        @else
                            <h5 class="fw-bold mb-3">
                                Paróquia:
                                {{ optional($paroquia)->nome_fantasia ?? optional($paroquia)->nome ?? 'Não associada' }}
                            </h5>
