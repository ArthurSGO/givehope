    ...
    <div class="container py-4">
        ...
        @if ($events->isEmpty())
            <div class="border rounded-3 p-5 text-center bg-body-tertiary">
                <h2 class="h5">Nenhum evento finalizado por aqui.</h2>
                <p class="text-muted mb-0">Quando uma ação terminar ela ficará registrada nesta página.</p>
            </div>
        @else
            <div class="row g-4">
                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <ul class="list-unstyled small text-muted mb-3">
                                    @if ($event->end_date)
                                        <li><i class="fa-solid fa-flag-checkered me-1"></i> Finalizado em {{ $event->end_date->format('d/m/Y') }}</li>
                                    @endif
                                    @if ($event->location)
